        ...
        <nav className="header-nav">
          {navLinks.map((link) => (
            ...
            >
              {link.label}
              {link.badge && (
                <span className="absolute -top-2 -right-2 notification-badge h-5 w-5 flex items-center justify-center">
                  {link.badge}
                </span>
              )}
            </Link>
          ...
          <div className="header-mobile-menu-links">
            {navLinks.map((link) => (
              ...
              >
                {link.label}
                {link.badge && (
                  <span className="absolute -top-1 -right-1 notification-badge h-4 w-4 flex items-center justify-center text-xs">
                    {link.badge}
                  </span>
                )}
              </Link>
